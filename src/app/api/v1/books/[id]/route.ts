...
const BOOK_COLUMNS =
  'id, status, progress, goal, occasion_pack, language, reading_level, title, theme, purchased_tier, cover_asset_id, error, created_at, updated_at, render_credits, editing_at';
