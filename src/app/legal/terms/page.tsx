...
export default function Terms() {
  return (
    <>
      ...
      <p style={p}>
        These Terms of Service (&quot;Terms&quot;) govern your use of MoonBell (&quot;MoonBell&quot;,
      ...
      <h2 className="display" style={h2}>1. What MoonBell does</h2>
      <p style={p}>
      ...
      <p style={p}>
        ...
        behalf. Children do not create or hold accounts. By using MoonBell you confirm you meet these
        requirements.
      </p>

      <h2 className="display" style={h2}>3. Your account</h2>
      <p style={p}>
        You access MoonBell through a parent account tied to your email address. You are responsible for
      ...
      <p style={p}>
        You agree to use MoonBell only for lawful, personal, non-commercial purposes and to follow our{' '}
      ...
      <p style={p}>
        MoonBell retains all rights in the underlying technology that powers the service, including our story
      ...
      <p style={p}>
        ...
        extent permitted by applicable law, MoonBell is not liable for indirect, incidental, special, or
      ...
      <p style={p}>
        You may stop using MoonBell and delete your account and data at any time from your{' '}
