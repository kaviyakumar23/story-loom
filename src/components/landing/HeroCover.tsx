...
const FEATURES: { t: string; d: string; c: string; icon: ReactNode }[] = [
  ...
  { t: 'Safe & private', d: PHOTO_LIKENESS_ENABLED ? 'Photo optional — used once, then deleted. Your child’s data is never shared.' : 'No photos required. Your child’s data is never shared.', c: 'var(--gold)', icon: <><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3Z" /><path d="M9 12l2 2 4-4" /></> },
...
const TRUST = [
  ...
  PHOTO_LIKENESS_ENABLED ? 'Photos are optional' : 'No child photos — ever',
