    ...
    <header className="web-header">
      <div className="web-header-inner">
        <Link href="/" className="brandmark">
          ...
          <span className="display" style={{ fontSize: 25, color: 'var(--brand)' }}>Storyloom</span>
        </Link>
...
export function Footer() {
  const cols = [
    { h: 'Storyloom', items: ['How it works', 'Sample pages', 'Pricing'] },
      ...
      <div className="container" style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr 1fr', gap: 40, padding: '56px 40px 30px' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 14 }}>
            ...
            <span className="display" style={{ fontSize: 23, color: '#fff' }}>Storyloom</span>
          </div>
